...
describe('UserRepository interface', () => {
  it('should throw error when invoke abstract behavior', async () => {
    ...
    await expect(userRepository.getUsernameByThreadId('')).rejects.toThrowError(
      'USER_REPOSITORY.METHOD_NOT_IMPLEMENTED'
    );
    await expect(
      userRepository.getUsernameByThreadIdFromReplies('')
    ).rejects.toThrowError('USER_REPOSITORY.METHOD_NOT_IMPLEMENTED');
    await expect(
      userRepository.getUsernameByThreadIdFromComment('')
    ).rejects.toThrowError('USER_REPOSITORY.METHOD_NOT_IMPLEMENTED');
